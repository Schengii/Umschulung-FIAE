(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(t){if(t.ep)return;t.ep=!0;const r=n(t);fetch(t.href,r)}})();const be="modulepreload",fe=function(s){return"/"+s},le={},R=function(e,n,i){let t=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),o=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));t=Promise.allSettled(n.map(l=>{if(l=fe(l),l in le)return;le[l]=!0;const c=l.endsWith(".css"),b=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${b}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":be,c||(p.as="script"),p.crossOrigin="",p.href=l,o&&p.setAttribute("nonce",o),document.head.appendChild(p),c)return new Promise((h,g)=>{p.addEventListener("load",h),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return t.then(a=>{for(const o of a||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})},A={JOBS:"jobmatch_jobs",PROFILE:"jobmatch_profile",PROFILES:"jobmatch_profiles",ACTIVE_PROFILE_ID:"jobmatch_active_profile_id",WEIGHTS:"jobmatch_weights"},de={name:"Alex Neumann",title:"Frontend Developer",skills:["JavaScript","HTML5","CSS Grid","React","Figma","TypeScript","Responsive Design","Git"],experience:`- 3 Jahre Erfahrung als Webentwickler im E-Commerce
- Erstellung von responsiven User Interfaces
- Erfahrung mit REST APIs und State Management`,geminiApiKey:"",geminiModel:"gemini-1.5-flash",geminiTemperature:.7,geminiCustomInstructions:"",lrsEnabled:!1,rgsEnabled:!1,taxClass:"1",churchTax:"0",hasChildren:!1,supabaseUrl:"",supabaseAnonKey:"",themePrimaryHue:239,themeSecondaryHue:263,weeklyGoal:3,cvText:""},ce={salary:4,commute:2,remote:5,culture:3,tech:4},ve=[{id:"mock-1",title:"Senior Frontend Developer (m/w/d)",company:"InnoTech Solutions",location:"München / Hybrid",workMode:"Hybrid",salary:72e3,url:"https://example.com/jobs/innotech-frontend",deadline:"2026-06-30",description:"Wir suchen einen Frontend-Enthusiasten mit fundierten Kenntnissen in JavaScript, React und CSS Grid. Erfahrung mit TypeScript und Figma ist ein großes Plus.",status:"interviewing",ratings:{salary:8,commute:6,remote:8,culture:7,tech:9},createdAt:"2026-06-01T10:00:00.000Z"},{id:"mock-2",title:"Web Entwickler / React Specialist",company:"Global Commerce GmbH",location:"Remote",workMode:"Remote",salary:65e3,url:"https://example.com/jobs/global-react",deadline:"2026-07-15",description:"Deine Aufgaben: Weiterentwicklung unserer Storefronts in React und TypeScript. Enge Abstimmung mit UX-Designern in Figma. Kenntnisse in REST APIs und Git vorausgesetzt.",status:"applied",ratings:{salary:7,commute:10,remote:10,culture:8,tech:8},createdAt:"2026-06-03T14:30:00.000Z"},{id:"mock-3",title:"Junior UI Engineer",company:"DesignKraft Agency",location:"Berlin / Vor Ort",workMode:"Vor Ort",salary:48e3,url:"https://example.com/jobs/designkraft-junior",deadline:"2026-06-18",description:"Unterstütze uns bei der Umsetzung von kreativen Websites. Du liebst HTML5, CSS Grid und Responsive Design? Adobe XD und Figma sind dir keine Fremdwörter?",status:"saved",ratings:{salary:5,commute:4,remote:2,culture:9,tech:7},createdAt:"2026-06-05T09:15:00.000Z"},{id:"mock-4",title:"Frontend Lead Developer",company:"CoreByte Systems",location:"München",workMode:"Vor Ort",salary:85e3,url:"https://example.com/jobs/corebyte-lead",deadline:"2026-06-25",description:"Architektur unserer Frontend-Systeme. Stack: Next.js, TypeScript, TailwindCSS. Du koordinierst das Entwickler-Team und stimmst dich mit dem Produktmanagement ab.",status:"offer",ratings:{salary:9,commute:4,remote:3,culture:6,tech:8},createdAt:"2026-05-28T16:00:00.000Z"}],x={getJobs(){const s=localStorage.getItem(A.JOBS);let e=[];s?e=JSON.parse(s):(e=ve,this.saveJobs(e));let n=!1;const i=e.map(t=>{let r=!1;return(!t.todos||!Array.isArray(t.todos))&&(t.todos=[],r=!0),(!t.interviews||!Array.isArray(t.interviews))&&(t.interviews=[],r=!0),(!t.communicationLogs||!Array.isArray(t.communicationLogs))&&(t.communicationLogs=[],r=!0),(!t.expenses||!Array.isArray(t.expenses))&&(t.expenses=[],r=!0),(!t.documents||!Array.isArray(t.documents))&&(t.documents=[],r=!0),r&&(n=!0),t});return n&&this.saveJobs(i),i},saveJobs(s){localStorage.setItem(A.JOBS,JSON.stringify(s));const e=this.getProfile();R(()=>import("./supabaseSync-CNVu12db.js"),[]).then(n=>{n.supabaseSync.syncJobs(e,s)}).catch(n=>console.warn("Supabase jobs sync failed:",n)),window.app&&typeof window.app.updateNotificationBell=="function"&&window.app.updateNotificationBell()},addJob(s){const e=this.getJobs(),n={...s,id:"job-"+Date.now(),createdAt:new Date().toISOString()};return e.push(n),this.saveJobs(e),n},updateJob(s){const e=this.getJobs(),n=e.findIndex(i=>i.id===s.id);return n!==-1?(e[n]={...e[n],...s},this.saveJobs(e),!0):!1},deleteJob(s){const n=this.getJobs().filter(i=>i.id!==s);this.saveJobs(n)},getProfiles(){let s=localStorage.getItem(A.PROFILES),e=localStorage.getItem(A.ACTIVE_PROFILE_ID),n=[];if(s)try{n=JSON.parse(s)}catch{}const i=localStorage.getItem(A.PROFILE);if(!n||n.length===0){let r=de;if(i)try{r=JSON.parse(i)}catch{}r.id||(r.id="prof-default"),r.profileName||(r.profileName=r.name||"Standard Profil"),n=[r],localStorage.setItem(A.PROFILES,JSON.stringify(n))}let t=!1;return n=n.map((r,a)=>(r.id||(r.id="prof-"+a+"-"+Date.now(),t=!0),r.profileName||(r.profileName=r.name||`Profil ${a+1}`,t=!0),r)),t&&localStorage.setItem(A.PROFILES,JSON.stringify(n)),(!e||!n.some(r=>r.id===e))&&(e=n[0].id,localStorage.setItem(A.ACTIVE_PROFILE_ID,e)),n},getActiveProfileId(){return this.getProfiles(),localStorage.getItem(A.ACTIVE_PROFILE_ID)},setActiveProfileId(s){const e=this.getProfiles();if(e.some(n=>n.id===s)){localStorage.setItem(A.ACTIVE_PROFILE_ID,s);const n=e.find(i=>i.id===s);localStorage.setItem(A.PROFILE,JSON.stringify(n)),R(()=>import("./supabaseSync-CNVu12db.js"),[]).then(i=>{i.supabaseSync.syncProfile(n);const t=this.getJobs();i.supabaseSync.syncJobs(n,t)}).catch(i=>console.warn("Supabase profile sync failed:",i))}},getProfile(){const s=this.getProfiles(),e=this.getActiveProfileId();return s.find(n=>n.id===e)||s[0]},saveProfile(s){s.id||(s.id=this.getActiveProfileId()||"prof-default"),s.profileName||(s.profileName=s.name||"Standard Profil");const e=this.getProfiles(),n=e.findIndex(t=>t.id===s.id);n!==-1?e[n]=s:e.push(s),localStorage.setItem(A.PROFILES,JSON.stringify(e)),this.getActiveProfileId()===s.id&&(localStorage.setItem(A.PROFILE,JSON.stringify(s)),R(()=>import("./supabaseSync-CNVu12db.js"),[]).then(t=>{t.supabaseSync.syncProfile(s);const r=this.getJobs();t.supabaseSync.syncJobs(s,r)}).catch(t=>console.warn("Supabase profile sync failed:",t)))},addProfile(s){const e=this.getProfiles(),n=this.getProfile(),i={...de,...n,id:"prof-"+Date.now(),profileName:s,name:n.name||"Alex Neumann",skills:[...n.skills],experience:n.experience||""};return e.push(i),localStorage.setItem(A.PROFILES,JSON.stringify(e)),this.setActiveProfileId(i.id),i},deleteProfile(s){let e=this.getProfiles();if(e.length<=1)throw new Error("Das letzte verbleibende Profil kann nicht gelöscht werden.");e=e.filter(i=>i.id!==s),localStorage.setItem(A.PROFILES,JSON.stringify(e)),this.getActiveProfileId()===s&&this.setActiveProfileId(e[0].id)},getWeights(){const s=localStorage.getItem(A.WEIGHTS);return s?JSON.parse(s):(this.saveWeights(ce),ce)},saveWeights(s){localStorage.setItem(A.WEIGHTS,JSON.stringify(s))},exportBackup(){return JSON.stringify({version:"1.0",jobs:this.getJobs(),profile:this.getProfile(),weights:this.getWeights()},null,2)},importBackup(s){try{const e=JSON.parse(s);if(!e.jobs||!Array.isArray(e.jobs)||!e.profile||!e.weights)throw new Error("Ungültiges Format: jobs, profile oder weights fehlen.");return this.saveJobs(e.jobs),this.saveProfile(e.profile),this.saveWeights(e.weights),!0}catch(e){throw console.error("Backup Import fehlgeschlagen",e),e}}},we=["javascript","html5","html","css grid","css","react","vue","angular","typescript","node.js","node","next.js","tailwind","figma","ui","ux","git","github","python","java","c#","c++","docker","kubernetes","aws","cloud","rest api","api","scrum","agile","projektmanagement","sql","nosql","mongodb","responsive design","adobe xd","sketch","english","deutsch"],z={async fetchJobDescriptionFromUrl(s){if(!s)throw new Error("Keine URL angegeben.");const e=`https://api.allorigins.win/get?url=${encodeURIComponent(s)}`,n=await fetch(e);if(!n.ok)throw new Error("Fehler beim Abrufen der URL.");const t=(await n.json()).contents;if(!t)throw new Error("Keine Inhalte unter dieser URL gefunden.");const a=new DOMParser().parseFromString(t,"text/html");let o=a.body;const l=a.querySelector("#jobDescriptionText")||a.querySelector(".jobsearch-JobComponent-description"),c=a.querySelector(".show-more-less-html__markup")||a.querySelector(".jobs-description__content")||a.querySelector(".description__text"),b=a.querySelector(".job-description")||a.querySelector(".js-app-ld-content")||a.querySelector(".g-job-description");return l?o=l:c?o=c:b&&(o=b),o.querySelectorAll("script, style, head, nav, footer, header, iframe, noscript, button, input").forEach(h=>h.remove()),(o.innerText||o.textContent||"").replace(/\s+/g," ").trim().slice(0,5e3)},async testApiKey(s){var l,c,b,p,h,g;if(!s||!s.trim())throw new Error("Kein API-Key angegeben.");const i=`https://generativelanguage.googleapis.com/v1beta/models/${x.getProfile().geminiModel||"gemini-1.5-flash"}:generateContent?key=${s}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:"Antworte kurz mit dem Wort 'OK', wenn du mich hoerst."}]}]})});if(!r.ok){const f=await r.json();throw new Error(((l=f.error)==null?void 0:l.message)||"Verbindung fehlgeschlagen.")}if(!((g=(h=(p=(b=(c=(await r.json()).candidates)==null?void 0:c[0])==null?void 0:b.content)==null?void 0:p.parts)==null?void 0:h[0])==null?void 0:g.text))throw new Error("Keine Antwort von der API erhalten.");return!0},extractKeywords(s){if(!s)return[];const e=s.toLowerCase(),n=we.filter(i=>{const t=i.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&");return new RegExp(`\\b${t}\\b|\\b${t}`,"i").test(e)});return[...new Set(n)]},analyzeMatch(s,e){if(!e)return{matchScore:0,matchingSkills:[],missingSkills:[]};const n=this.extractKeywords(e);if(n.length===0){const l=e.toLowerCase(),c=s.filter(b=>{const p=b.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&");return new RegExp(`\\b${p}\\b`,"i").test(l)});return{matchScore:s.length>0?Math.round(c.length/Math.min(s.length,5)*100):0,matchingSkills:c,missingSkills:[]}}const i=s.map(l=>l.toLowerCase().trim()),t=[],r=[];n.forEach(l=>{if(i.some(b=>b===l||b.includes(l)||l.includes(b))){const b=s.find(p=>p.toLowerCase().trim()===l)||l.charAt(0).toUpperCase()+l.slice(1);t.push(b)}else r.push(l.charAt(0).toUpperCase()+l.slice(1))});const a=n.length,o=a>0?Math.round(t.length/a*100):0;return{matchScore:Math.min(o,100),matchingSkills:t,missingSkills:r}},generateCoverLetter(s,e){return s.geminiApiKey&&s.geminiApiKey.trim()?this.generateRealCoverLetter(s.geminiApiKey,s,e):new Promise(n=>{setTimeout(()=>{const{matchingSkills:i,missingSkills:t}=this.analyzeMatch(s.skills,e.description),r=`Sehr geehrtes Team von ${e.company},

`,a=`mit großem Interesse habe ich Ihre Ausschreibung für die Position als **${e.title}** gelesen. Da mein Profil ideal zu den von Ihnen genannten Anforderungen passt, möchte ich mich Ihnen gerne vorstellen.

`;let o="";i.length>0?(o=`In meiner bisherigen Laufbahn konnte ich fundierte Erfahrungen in Projekten sammeln, bei denen insbesondere **${i.slice(0,3).join(", ")}** im Fokus standen. `,i.includes("React")||i.includes("JavaScript")?o+="Besonders die Entwicklung moderner, performanter Webanwendungen auf Basis aktueller UI-Bibliotheken liegt mir sehr. ":(i.includes("Figma")||i.includes("UI")||i.includes("UX"))&&(o+="Die enge Zusammenarbeit an der Schnittstelle zwischen User Experience und Design unter Nutzung moderner Tools gehört zu meinem täglichen Handwerk. "),o+=`Die von Ihnen geforderten Kompetenzen in **${i.join(", ")}** bringe ich daher direkt mit und kann Ihr Team ab Tag eins produktiv unterstützen.

`):o=`Als motivierter ${s.title||"Entwickler"} bringe ich eine große Lernbereitschaft und Begeisterung für neue Webtechnologien mit. Ich bin es gewohnt, mich schnell in neue Frameworks und Arbeitsweisen einzuarbeiten und komplexe Probleme strukturiert zu lösen.

`;let l="";s.experience?l=`Wie Sie meinem Profil entnehmen können, bringe ich Erfahrung im folgenden Bereich mit: "${s.experience.split(`
`)[0].replace(/^-\s*/,"")}". Diese Vorkenntnisse ermöglichen es mir, technische Anforderungen zügig in sauberen Code zu übersetzen.

`:l=`Ich freue mich darauf, meine Fähigkeiten in einem dynamischen Umfeld wie dem Ihren einzusetzen und mich stetig weiterzuentwickeln.

`;const c=`Für Fragen stehe ich Ihnen jederzeit gerne zur Verfügung und freue mich über die Einladung zu einem persönlichen Kennenlernen.

Mit freundlichen Grüßen,
${s.name||"Max Mustermann"}`,b=r+a+o+l+c;n(b)},1e3)})},async generateRealCoverLetter(s,e,n){var h,g,f,u,m,d;const i=e.geminiModel||"gemini-1.5-flash",t=e.geminiTemperature!==void 0?e.geminiTemperature:.7,r=e.geminiCustomInstructions||"",a=`https://generativelanguage.googleapis.com/v1beta/models/${i}:generateContent?key=${s}`;let o="Du bist ein professioneller Karriere-Coach und Bewerbungs-Schreiber. Du verfasst überzeugende, maßgeschneiderte Anschreiben in deutscher Sprache.";r&&(o+=`
Beachte zusätzlich folgende Schreibstil-Anweisungen des Benutzers: ${r}`);const c={contents:[{parts:[{text:`Erstelle ein professionelles Bewerbungsanschreiben auf Deutsch für folgende Position:
Stellentitel: ${n.title}
Unternehmen: ${n.company}
Standort: ${n.location||"K.A."}
Arbeitsmodell: ${n.workMode||"K.A."}

Bewerber-Details:
Name: ${e.name||"Max Mustermann"}
Fokus/Berufsbezeichnung: ${e.title||"Entwickler"}
...
Gib das Ergebnis als valides JSON-Array zurück. Jede Frage im Array muss exakt die Attribute "id", "question", "strategy" und "sampleAnswer" aufweisen (alles als Strings).`}]}],systemInstruction:{parts:[{text:o}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"ARRAY",items:{type:"OBJECT",properties:{id:{type:"INTEGER"},question:{type:"STRING"},strategy:{type:"STRING"},sampleAnswer:{type:"STRING"}},required:["id","question","strategy","sampleAnswer"]}},temperature:t}},p=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(b)});if(!p.ok){const S=await p.json();throw new Error(((f=S.error)==null?void 0:f.message)||"Fehler bei der Gemini-API-Anfrage.")}const g=(k=(v=(d=(m=(u=(await p.json()).candidates)==null?void 0:u[0])==null?void 0:m.content)==null?void 0:d.parts)==null?void 0:v[0])==null?void 0:k.text;if(!g)throw new Error("Keine Antwort erhalten.");return JSON.parse(g)},async parseJobDescription(s,e){if(!e||!e.trim())throw new Error("Bitte geben Sie einen Text ein, der analysiert werden soll.");return s&&s.trim()?this.parseRealJobDescription(s,e):new Promise(n=>{setTimeout(()=>{const i=e.split(`
`).map(d=>d.trim()).filter(d=>d.length>0);let t="Unbekannter Jobtitel",r="Unbekanntes Unternehmen",a=0,o="Deutschland",l="Hybrid",c="";const b=["entwickler","developer","designer","ingenieur","engineer","manager","berater","consultant","architect","spezialist","specialist"];for(const d of i.slice(0,5))if(b.some(v=>d.toLowerCase().includes(v))){t=d;break}const p=["gmbh","ag","co. kg","se","solutions","technologies","group","partner"];for(const d of i)if(p.some(v=>d.toLowerCase().includes(v))){r=d.replace(/(wir suchen|jobs|stelle|karriere|bei)\s*/i,"").trim();break}const h=/(?:gehalt|verdienst|einkommen|salär|jahresgehalt|vergütung)?\s*(?:bis|von|ca\.)?\s*([0-9]{2,3}(?:\.[0-9]{3})?)\s*(?:€|euro|\$)/i,g=e.match(h);if(g)a=parseInt(g[1].replace(".",""),10);else{const d=e.match(/\b(2[5-9][0-9]{3}|[3-9][0-9]{4}|1[0-8][0-9]{4})\b/);d&&(a=parseInt(d[1],10))}/remote|homeoffice|home-office|zuhause|work from home/i.test(e)?l="Remote":/hybrid|flexibel/i.test(e)?l="Hybrid":/vor ort|präsenz|büro/i.test(e)&&(l="Vor Ort");const f=["berlin","münchen","hamburg","köln","frankfurt","stuttgart","düsseldorf","dortmund","essen","bremen","leipzig","dresden","nürnberg","karlsruhe"];for(const d of e.toLowerCase().split(/[^a-zäöüß]/))if(f.includes(d)){o=d.charAt(0).toUpperCase()+d.slice(1);break}const u=/(?:ansprechpartner|kontakt|bewerben an|kontaktperson|recruiter|hr-manager|hr)\s*(?:ist|unter|:)?\s*([A-Z][a-z]+(?:\s+[A-Z][a-z]+)+)/,m=e.match(u);m&&(c=m[1]),n({title:t,company:r,salary:a,location:o,workMode:l,description:e.slice(0,1e3)+(e.length>1e3?"...":""),contact:c})},1e3)})},async parseRealJobDescription(s,e){var h,g,f,u,m,d;const t=`https://generativelanguage.googleapis.com/v1beta/models/${x.getProfile().geminiModel||"gemini-1.5-flash"}:generateContent?key=${s}`,l={contents:[{parts:[{text:`Analysiere folgende Stellenbeschreibung und extrahiere die Kerndaten:
---
${e}
---
...
Gib ausschließlich das JSON-Objekt zurück.`}]}],systemInstruction:{parts:[{text:"Du bist ein intelligenter Daten-Extraktor. Analysiere den bereitgestellten Text einer Stellenanzeige und extrahiere strukturierte Daten auf Deutsch."}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"OBJECT",properties:{title:{type:"STRING"},company:{type:"STRING"},salary:{type:"INTEGER"},location:{type:"STRING"},workMode:{type:"STRING"},description:{type:"STRING"},contact:{type:"STRING"}},required:["title","company","salary","location","workMode","description","contact"]},temperature:.1}},c=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)});if(!c.ok){const v=await c.json();throw new Error(((h=v.error)==null?void 0:h.message)||"Fehler bei der Gemini-API-Anfrage.")}const p=(d=(m=(u=(f=(g=(await c.json()).candidates)==null?void 0:g[0])==null?void 0:f.content)==null?void 0:u.parts)==null?void 0:m[0])==null?void 0:d.text;if(!p)throw new Error("Keine Antwort erhalten.");return JSON.parse(p)},async evaluateInterviewAnswer(s,e,n){if(!n||!n.trim())throw new Error("Bitte geben Sie eine Antwort ein, die bewertet werden soll.");return s&&s.trim()?this.evaluateRealInterviewAnswer(s,e,n):new Promise(i=>{setTimeout(()=>{const t=n.trim().split(/\s+/).length;let r=50;t<10?r-=20:t>=10&&t<30?r+=10:t>=30&&t<80?r+=25:r+=30;const a=["projekt","erfahrung","herausforderung","gelöst","team","kunde","kunden","kommunikation","lösung","lernen","struktur","star","situation","ziel","ergebnis"];let o=[];a.forEach(b=>{n.toLowerCase().includes(b)&&(r+=3,o.push(b))}),r=Math.min(Math.max(r,10),100);let l="",c="";r<50?(l="Deine Antwort ist sehr kurz geraten und geht kaum auf die Facetten der Frage ein. Recruiter möchten in der Regel mehr Kontext und Details hören.",c="Versuche, deine Antwort nach der STAR-Methode aufzubauen: Welches Problem lag vor? Was war deine Aufgabe? Was hast du konkret getan? Und was war das messbare Resultat?"):r>=50&&r<75?(l=`Guter Ansatz! Du hast bereits einige wichtige Aspekte genannt (z.B. Wörter wie: ${o.join(", ")||"keine"}). Deine Antwort ist strukturiert, könnte aber noch mit einem konkreteren Beispiel belegt werden.`,c="Untermauere deine Behauptungen mit einem echten Ereignis aus deiner Praxis. Erzähle eine kurze Story, wie du genau vorgegangen bist. Das wirkt authentischer und überzeugender."):(l=`Hervorragende Antwort! Du hast sehr detailliert geantwortet (${t} Wörter) und wichtige Begriffe wie ${o.join(", ")||"Berufserfahrung"} verwendet. Damit vermittelst du Professionalität und Struktur.`,c="Deine Antwort ist bereits sehr stark. Achte beim Vorlesen darauf, ruhig und selbstbewusst zu sprechen. Die Antwort ist perfekt vorbereitet!"),i({score:r,feedback:l,suggestions:c})},1e3)})},async evaluateRealInterviewAnswer(s,e,n){var u,m,d,v,k,S;const i=x.getProfile(),t=i.geminiModel||"gemini-1.5-flash",r=i.geminiTemperature!==void 0?i.geminiTemperature:.7,a=i.geminiCustomInstructions||"",o=`https://generativelanguage.googleapis.com/v1beta/models/${t}:generateContent?key=${s}`;let l="Du bist ein professioneller Karriere-Coach. Bewerte die Antwort des Bewerbers ehrlich, professionell und konstruktiv auf Deutsch.";a&&(l+=`
Beachte zusätzlich folgende Schreibstil-Anweisungen des Benutzers: ${a}`);const p={contents:[{parts:[{text:`Bewerte die folgende Antwort des Bewerbers auf die Interviewfrage:
Frage: ${e}
...
Gib ausschließlich das JSON-Objekt zurück.`}]}],systemInstruction:{parts:[{text:l}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"OBJECT",properties:{score:{type:"INTEGER"},feedback:{type:"STRING"},suggestions:{type:"STRING"}},required:["score","feedback","suggestions"]},temperature:r}},h=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(p)});if(!h.ok){const $=await h.json();throw new Error(((u=$.error)==null?void 0:u.message)||"Fehler bei der Gemini-API-Anfrage.")}const f=(S=(k=(v=(d=(m=(await h.json()).candidates)==null?void 0:m[0])==null?void 0:d.content)==null?void 0:v.parts)==null?void 0:k[0])==null?void 0:S.text;if(!f)throw new Error("Keine Antwort erhalten.");return JSON.parse(f)},generateResumeOptimization(s,e,n){return s.geminiApiKey&&s.geminiApiKey.trim()?this.generateRealResumeOptimization(s.geminiApiKey,s,e,n):new Promise(i=>{setTimeout(()=>{const t=this.extractKeywords(e.description),r=this.extractKeywords(n),a=t.filter(f=>r.includes(f)),o=t.filter(f=>!r.includes(f)),l=t.length;let c=l>0?Math.round(a.length/l*100):50;(!n||!n.trim())&&(c=10);const b=a.map(f=>f.charAt(0).toUpperCase()+f.slice(1)),p=o.map(f=>f.charAt(0).toUpperCase()+f.slice(1)),h=[];if(o.length>0){const f=p[0];h.push({original:"Kenntnisse in der Softwareentwicklung.",improved:`Konzeption und Implementierung robuster Softwarelösungen unter Anwendung von ${f} für strukturierte Arbeitsabläufe.`,why:`Hebt deine Kompetenz in ${f} aktiv hervor und verwendet stärkere Aktionsverben.`})}if(a.length>0){const f=b[0];h.push({original:`Ich habe mit ${f} gearbeitet.`,improved:`Erfolgreiche Integration von ${f} in produktiven Projekten zur Optimierung der Benutzerfreundlichkeit und Ladezeiten.`,why:"Stellt den konkreten geschäftlichen Mehrwert (Ladezeiten, UX) in den Vordergrund."})}else h.push({original:"Erstellung von Frontends und Webseiten.",improved:"Entwicklung hochperformanter, responsiver Benutzeroberflächen unter Einhaltung moderner Accessibility- und Design-Standards.",why:"Verwendet präzisere Fachbegriffe und zeigt Fokus auf Performance und Barrierefreiheit."});h.push({original:"Zusammenarbeit mit Kollegen im Team.",improved:"Agile Zusammenarbeit in interdisziplinären Teams unter Nutzung von Git, Scrum und kollaborativen Design-Tools wie Figma.",why:"Spezifiziert deine agilen Arbeitsmethoden und genutzten Tools."});const g=n&&n.trim()?`Dein Lebenslauf hat bereits eine solide Basis (Match Score: ${c}%). Um für die Stelle als ${e.title} bei ${e.company} maximal attraktiv zu sein, solltest du die fehlenden Schlagworte wie ${p.slice(0,3).join(", ")||"keine"} prominenter in deinen Projekten platzieren. Achte darauf, deine Erfahrungsergebnisse messbar zu beschreiben.`:"Füge deinen Lebenslauf-Text im Eingabebereich ein, um eine detaillierte Keyword-Analyse und maßgeschneiderte Verbesserungsvorschläge für dieses Stellenprofil zu erhalten.";i({score:c,matchingKeywords:b,missingKeywords:p,bulletPoints:h,generalTips:g})},1e3)})},async generateRealResumeOptimization(s,e,n,i){var u,m,d,v,k,S;const t=e.geminiModel||"gemini-1.5-flash",r=e.geminiTemperature!==void 0?e.geminiTemperature:.7,a=e.geminiCustomInstructions||"",o=`https://generativelanguage.googleapis.com/v1beta/models/${t}:generateContent?key=${s}`;let l="Du bist ein professioneller Karriere-Coach und HR-Analyst. Du analysierst den Lebenslauf eines Bewerbers im Vergleich zu einer Stellenausschreibung. Du lieferst detailliertes Feedback, berechnest einen Match-Score und gibst konkrete Vorschläge zur Optimierung von Lebenslauf-Formulierungen.";a&&(l+=`
Beachte zusätzlich folgende Schreibstil-Anweisungen des Benutzers: ${a}`);const p={contents:[{parts:[{text:`Vergleiche den Lebenslauf des Bewerbers mit der Stellenbeschreibung.
Stellentitel: ${n.title}
Unternehmen: ${n.company}
Stellenbeschreibung:
${n.description||"Keine Angabe"}
...
Gib ausschließlich das JSON-Objekt zurück.`}]}],systemInstruction:{parts:[{text:l}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"OBJECT",properties:{score:{type:"INTEGER"},matchingKeywords:{type:"ARRAY",items:{type:"STRING"}},missingKeywords:{type:"ARRAY",items:{type:"STRING"}},bulletPoints:{type:"ARRAY",items:{type:"OBJECT",properties:{original:{type:"STRING"},improved:{type:"STRING"},why:{type:"STRING"}},required:["original","improved","why"]}},generalTips:{type:"STRING"}},required:["score","matchingKeywords","missingKeywords","bulletPoints","generalTips"]},temperature:r}},h=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(p)});if(!h.ok){const $=await h.json();throw new Error(((u=$.error)==null?void 0:u.message)||"Fehler bei der Gemini-API-Anfrage.")}const f=(S=(k=(v=(d=(m=(await h.json()).candidates)==null?void 0:m[0])==null?void 0:d.content)==null?void 0:v.parts)==null?void 0:k[0])==null?void 0:S.text;if(!f)throw new Error("Keine Antwort erhalten.");return JSON.parse(f)},generateEmail(s,e,n,i){return s.geminiApiKey&&s.geminiApiKey.trim()?this.generateRealEmail(s.geminiApiKey,s,e,n,i):new Promise(t=>{setTimeout(()=>{e.contact;const r=s.name||"Alex Neumann",a=e.title,o=e.company;let l="";if(n==="status")i==="formal"?l=`Sehr geehrte(r) Frau/Herr ${e.contact||"Ansprechpartner"},
...
Viele Grüße,
${r}`;else if(n==="negotiate"){const c=e.salary?`${e.salary.toLocaleString("de-DE")} €`:"das besprochene Gehalt";i==="formal"?l=`Sehr geehrte(r) Frau/Herr ${e.contact||"Ansprechpartner"},
...
Nach Durchsicht des Vertragsentwurfs hätte ich noch ein Anliegen bezüglich der Rahmenbedingungen. Angesichts meiner Qualifikationen und der besprochenen Anforderungen würde ich gerne fragen, ob beim Gehalt ein Spielraum in Richtung 8-10% über den angebotenen ${c} besteht oder ob wir dies durch zusätzliche Benefits (wie z. B. Übernahme des Jobtickets oder Weiterbildungsbudgets) ausgleichen können.
...
Ich habe mir den Entwurf durchgeschaut und würde gerne noch einen Punkt ansprechen: Passt das Gehalt noch etwas ins Budget? Da wir über recht viel Verantwortung gesprochen haben, fände ich ein Grundgehalt, das etwa 5-10% über den vorgeschlagenen ${c} liegt, passender. Alternativ können wir auch gerne über zusätzliche Benefits wie extra Urlaubstage oder Fortbildungsbudgets sprechen.
...
Gib ausschließlich den Text der E-Mail ohne Betreffzeile, Markdowns oder sonstige Erklärungen zurück.`}]}],systemInstruction:{parts:[{text:c}]},generationConfig:{temperature:a}},g=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h)});if(!g.ok){const L=await g.json();throw new Error(((m=L.error)==null?void 0:m.message)||"Fehler bei der Gemini-API-Anfrage.")}const u=($=(S=(k=(v=(d=(await g.json()).candidates)==null?void 0:d[0])==null?void 0:v.content)==null?void 0:k.parts)==null?void 0:S[0])==null?void 0:$.text;if(!u)throw new Error("Keine Antwort erhalten.");return u},async parseCVText(s,e){if(!e||!e.trim())throw new Error("Lebenslauf-Text ist leer.");return s&&s.trim()?this.parseRealCVText(s,e):new Promise(n=>{setTimeout(()=>{const i=e.split(`
`).map(c=>c.trim()).filter(c=>c.length>0);let t="Alex Neumann",r="Software Entwickler";i.length>0&&(t=i[0]),i.length>1&&(r=i[1]);const o=this.extractKeywords(e).map(c=>c.charAt(0).toUpperCase()+c.slice(1)),l=i.slice(2,8).map(c=>"- "+c).join(`
`);n({name:t,title:r,skills:o,experience:l})},1e3)})},async parseRealCVText(s,e){var h,g,f,u,m,d;const t=`https://generativelanguage.googleapis.com/v1beta/models/${x.getProfile().geminiModel||"gemini-1.5-flash"}:generateContent?key=${s}`,l={contents:[{parts:[{text:`Analysiere den folgenden Lebenslauf-Text und extrahiere die Kerndaten des Bewerbers:
---
${e}
---
...
Gib ausschließlich das JSON-Objekt zurück.`}]}],systemInstruction:{parts:[{text:"Du bist ein intelligenter Lebenslauf-Extraktor. Analysiere den bereitgestellten Text eines Lebenslaufs und extrahiere strukturierte Profildaten auf Deutsch."}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"OBJECT",properties:{name:{type:"STRING"},title:{type:"STRING"},skills:{type:"ARRAY",items:{type:"STRING"}},experience:{type:"STRING"}},required:["name","title","skills","experience"]},temperature:.1}},c=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)});if(!c.ok){const v=await c.json();throw new Error(((h=v.error)==null?void 0:h.message)||"Fehler bei der Gemini-API-Anfrage.")}const p=(d=(m=(u=(f=(g=(await c.json()).candidates)==null?void 0:g[0])==null?void 0:f.content)==null?void 0:u.parts)==null?void 0:m[0])==null?void 0:d.text;if(!p)throw new Error("Keine Antwort erhalten.");return JSON.parse(p)},async negotiateSalary(s,e,n,i,t,r,a,o){return s&&s.trim()?this.negotiateRealSalary(s,e,n,i,t,r,a,o):new Promise(l=>{setTimeout(()=>{const c=Math.floor(a.length/2)+1;let b="",p=!1,h=null,g=null,f=null;if(c===1){const u=Math.round(t*.9);b=`Hallo! Schön, dass wir über die Konditionen sprechen. Für die Position als ${e} bei ${n} haben wir ein Budget geplant. Ihre Vorstellung liegt etwas über unserem Rahmen. Wir könnten Ihnen zum Einstieg ein Grundgehalt von ${u.toLocaleString("de-DE")} € anbieten. Was sagen Sie dazu?`}else c===2?b=`Ich verstehe Ihre Argumente bezüglich Ihrer Erfahrung. Allerdings müssen wir auch die interne Gehaltsstruktur berücksichtigen. Ich habe mit der Fachabteilung Rücksprache gehalten: Wir könnten uns auf ${Math.round(t*.97).toLocaleString("de-DE")} € sowie zusätzliche Benefits (z. B. ÖPNV-Ticket oder Weiterbildungsbudget) einigen. Liegt das in Ihrem Bereich?`:(p=!0,h=Math.round((parseFloat(i)+parseFloat(t))/2),g=80,f="Gute Argumentation über persönliche Qualifikationen. Etwas mehr Flexibilität bei Zusatzleistungen hätte die Verhandlung beschleunigen können.",b=`Das ist unser absolutes Limit: Wir bieten Ihnen ${h.toLocaleString("de-DE")} € als fixes Jahresbruttogehalt. Mehr lässt unser Budgetrahmen für diese Position leider nicht zu. Wir würden uns sehr freuen, Sie an Bord zu haben!`);l({text:b,endNegotiation:p,finalSalary:h,rating:g,feedback:f})},1e3)})},async negotiateRealSalary(s,e,n,i,t,r,a,o){var m,d,v,k,S,$;const l=`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${s}`,c=a.map(L=>`${L.sender==="user"?"Kandidat":"Recruiter"}: "${L.text}"`).join(`
`),b=Math.floor(a.length/2)+1,h={contents:[{parts:[{text:`Du bist ein professioneller Personalvermittler (Recruiter) und verhandelst das Gehalt für die Stelle als "${e}" bei der Firma "${n}".
...
- "feedback": 2-3 Sätze konstruktives Feedback dazu, wie geschickt der Kandidat verhandelt hat.`}]}],generationConfig:{responseMimeType:"application/json"}},g=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h)});if(!g.ok){const L=await g.json();throw new Error(((m=L.error)==null?void 0:m.message)||"Fehler bei der Gemini-API-Anfrage.")}const u=($=(S=(k=(v=(d=(await g.json()).candidates)==null?void 0:d[0])==null?void 0:v.content)==null?void 0:k.parts)==null?void 0:S[0])==null?void 0:$.text;if(!u)throw new Error("Keine Antwort erhalten.");return JSON.parse(u)}},xe="jobmatch_db",ke=1,D="documents";function _(){return new Promise((s,e)=>{const n=indexedDB.open(xe,ke);n.onupgradeneeded=i=>{const t=i.target.result;t.objectStoreNames.contains(D)||t.createObjectStore(D,{keyPath:"fileId"})},n.onsuccess=i=>s(i.target.result),n.onerror=i=>e(i.target.error)})}const Z={async saveFile(s,e,n,i){const t=await _();return new Promise((r,a)=>{const c=t.transaction(D,"readwrite").objectStore(D).put({fileId:s,jobId:e,filename:n,fileBlob:i});c.onsuccess=()=>r(),c.onerror=()=>a(c.error)})},async getFile(s){const e=await _();return new Promise((n,i)=>{const a=e.transaction(D,"readonly").objectStore(D).get(s);a.onsuccess=()=>n(a.result),a.onerror=()=>i(a.error)})},async deleteFile(s){const e=await _();return new Promise((n,i)=>{const a=e.transaction(D,"readwrite").objectStore(D).delete(s);a.onsuccess=()=>n(),a.onerror=()=>i(a.error)})}};function Q(s,e={}){if(!s||s<=0)return{netYearly:0,netMonthly:0,socialSecurityMonthly:0,taxMonthly:0};const n=parseInt(e.taxClass||"1",10),i=parseInt(e.churchTax||"0",10)/100,t=!!e.hasChildren,r=s/12,a=5175,o=7450,l={health:.081,care:t?.017:.022,pension:.046,unemp:.013},c=Math.min(r,a),b=Math.min(r,o),p=c*(l.health+l.care)+b*(l.pension+l.unemp),h=1266,g=p*12*.96,f=Math.max(0,s-g-h);let u=11784;n===2?u=16044:n===3?u=23568:(n===5||n===6)&&(u=0);let m=0;const d=u/11784;if(d===0)m=f*(n===6?.35:.28);else{const L=11784*d,P=17e3*d,N=66e3*d;if(f<=L)m=0;else if(f<=P){const M=(f-L)/(1e4*d);m=(922.3*M+1400)*M*d}else if(f<=N){const M=(f-P)/(1e4*d);m=((181.76*M+2400)*M+820)*d}else f<=277825?m=.42*f-10600*d:m=.45*f-18900*d}let v=0;m>18130&&(v=m*.055);const k=m*i,S=p*12+m+v+k,$=Math.max(0,s-S);return{netYearly:Math.round($),netMonthly:Math.round($/12),socialSecurityMonthly:Math.round(p),taxMonthly:Math.round((m+v+k)/12)}}const Se={chartInstance:null,salaryChartInstance:null,activityTrendChartInstance:null,render(s){const e=document.getElementById(s),n=x.getJobs(),i=x.getProfile(),t=x.getWeights();if(n.length===0){this.renderEmptyState(e);return}const r=n.length;n.filter(y=>y.status==="saved").length;const a=n.filter(y=>y.status==="applied"||y.status==="interviewing"||y.status==="offer").length,o=n.filter(y=>y.status==="interviewing").length,l=n.filter(y=>y.status==="offer").length;let c=0;n.forEach(y=>{y.expenses&&Array.isArray(y.expenses)&&y.expenses.forEach(w=>{c+=parseFloat(w.amount)||0})});const b=c.toLocaleString("de-DE",{style:"currency",currency:"EUR"}),p=r,h=n.filter(y=>["applied","interviewing","offer"].includes(y.status)).length,g=n.filter(y=>["interviewing","offer"].includes(y.status)).length,f=n.filter(y=>["offer"].includes(y.status)).length,u=Math.round(h/(p||1)*100),m=Math.round(g/(p||1)*100),d=Math.round(f/(p||1)*100),v=h>0?Math.round(g/h*100):0,k=g>0?Math.round(f/g*100):0;let S=0,$=0,L=0,P=0;n.forEach(y=>{const w=y.history||[],E=w.find(B=>B.status==="saved"),I=w.find(B=>B.status==="applied"),T=w.find(B=>B.status==="interviewing");if(E&&I){const B=Math.abs(new Date(I.timestamp)-new Date(E.timestamp));S+=Math.ceil(B/(1e3*60*60*24)),$++}if(I&&T){const B=Math.abs(new Date(T.timestamp)-new Date(I.timestamp));L+=Math.ceil(B/(1e3*60*60*24)),P++}});const N=$>0?Math.round(S/$):0,M=P>0?Math.round(L/P):0,Y=[...n.map(y=>{const w=z.analyzeMatch(i.skills,y.description),E=y.ratings||{salary:5,commute:5,remote:5,culture:5,tech:5},I=t.salary+t.commute+t.remote+t.culture+t.tech,T=E.salary*t.salary+E.commute*t.commute+E.remote*t.remote+E.culture*t.culture+E.tech*t.tech,B=Math.round(T/(I*10)*100);return{...y,compareScore:B,skillScore:w.matchScore}})].sort((y,w)=>w.compareScore-y.compareScore).slice(0,3),X=n.filter(y=>y.deadline&&y.status!=="rejected"&&y.status!=="offer").map(y=>{const w=new Date(y.deadline);return{id:y.id,title:y.title,company:y.company,deadline:y.deadline,day:w.getDate(),month:w.toLocaleString("de-DE",{month:"short"}),rawDate:w}}).sort((y,w)=>y.rawDate-w.rawDate).slice(0,4),G=new Date,ee=new Date(G);ee.setHours(23,59,59,999);const te=G.getDay(),ue=te===0?6:te-1,j=new Date(G);j.setHours(0,0,0,0),j.setDate(G.getDate()-(12*7+ue));const K={};n.forEach(y=>{if(y.createdAt){const E=new Date(y.createdAt).toISOString().slice(0,10);K[E]=(K[E]||0)+1}y.history&&Array.isArray(y.history)&&y.history.forEach(w=>{if(w.timestamp){const I=new Date(w.timestamp).toISOString().slice(0,10);K[I]=(K[I]||0)+1}})});let ne="";const H=new Date(j),ie=Array(13).fill("");let re="";const V=new Date(j);for(let y=0;y<13;y++){const w=V.toLocaleString("de-DE",{month:"short"});w!==re&&(ie[y]=w,re=w),V.setDate(V.getDate()+7)}for(;H<=ee;){const y=H.toISOString().slice(0,10),w=K[y]||0;let E=0;w===1?E=1:w===2?E=2:w===3?E=3:w>=4&&(E=4);const I=H.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric"}),T=`${w} ${w===1?"Aktivität":"Aktivitäten"} am ${I}`;ne+=`
            ...
            `,H.setDate(H.getDate()+1)}const C=i.weeklyGoal||3,J=new Date;J.setDate(J.getDate()-7);let F=0;n.forEach(y=>{let w=null;if(y.history&&Array.isArray(y.history)){const E=y.history.filter(I=>I.status==="applied");E.length>0&&(w=new Date(E[E.length-1].timestamp))}!w&&y.status==="applied"&&y.createdAt&&(w=new Date(y.createdAt)),w&&w>=J&&F++});const pe=Math.min(Math.round(F/C*100),100),me=F>=C,O=36,q=2*Math.PI*O,ge=q-pe/100*q;e.innerHTML=`
                    ...
                    <div class="glass-card funnel-card" style="padding: 24px; display: flex; flex-direction: column;">
                        ...
                        <div class="funnel-container" style="display: flex; flex-direction: column; gap: 14px; flex-grow: 1; justify-content: center;">
                            ...
                            <div class="funnel-step">
                                ...
                                <div style="background: rgba(255, 255, 255, 0.05); height: 8px; border-radius: 4px; overflow: hidden;">
                                    <div style="background: var(--primary); width: ${u}%; height: 100%; border-radius: 4px;"></div>
                                </div>
                            </div>
                            ...
                            <div class="funnel-step">
                                ...
                                <div style="background: rgba(255, 255, 255, 0.05); height: 8px; border-radius: 4px; overflow: hidden;">
                                    <div style="background: var(--success); width: ${d}%; height: 100%; border-radius: 4px;"></div>
                                </div>
                            </div>
                            ...
                            <div class="funnel-conversion-badges" style="display: flex; gap: 10px; margin-top: 8px; flex-wrap: wrap;">
                                <div style="background: rgba(99, 102, 241, 0.08); border: 1px solid rgba(99, 102, 241, 0.2); padding: 8px 10px; border-radius: 6px; flex: 1; min-width: 110px; text-align: center;">
                                    ...
                                    <strong style="font-size: 1rem; color: var(--primary); font-family: 'Outfit';">${v}%</strong>
                                </div>
                                <div style="background: rgba(16, 185, 129, 0.08); border: 1px solid rgba(16, 185, 129, 0.2); padding: 8px 10px; border-radius: 6px; flex: 1; min-width: 110px; text-align: center;">
                                    ...
                                    <strong style="font-size: 1rem; color: var(--success); font-family: 'Outfit';">${k}%</strong>
                                </div>
                                <div style="background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.2); padding: 8px 10px; border-radius: 6px; flex: 1; min-width: 110px; text-align: center;" title="Durchschnittliche Dauer von Speichern bis Bewerben">
                                    ...
                                    <strong style="font-size: 1.05rem; color: var(--warning); font-family: 'Outfit';">${N} Tage</strong>
                                </div>
                ...
                <div class="dashboard-activity-row" style="display: grid; grid-template-columns: 1.8fr 1fr; gap: 32px; margin-top: 32px; margin-bottom: 32px;">
                    ...
                    <div class="glass-card activity-card" style="padding: 24px; position: relative;">
                        ...
                        <div class="heatmap-wrapper" style="display: flex; flex-direction: column; gap: 6px;">
                            ...
                            <div class="heatmap-months" style="display: grid; grid-auto-flow: column; grid-auto-columns: 12px; gap: 3px; font-size: 0.65rem; color: var(--text-muted); height: 16px; margin-bottom: 2px; padding-left: 28px;">
                                ${ie.map(y=>`<div style="text-align: left; overflow: visible; white-space: nowrap;">${y}</div>`).join("")}
                            </div>
                    ...
                    <div class="glass-card goal-card" style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between; position: relative;">
                        ...
                        <div style="display: flex; align-items: center; justify-content: space-around; flex-grow: 1; gap: 20px;">
                            ...
                            <div style="position: relative; width: 90px; height: 90px; display: flex; align-items: center; justify-content: center;">
                                <svg width="90" height="90" viewBox="0 0 90 90" style="transform: rotate(-90deg);">
                                    <circle cx="45" cy="45" r="${O}" stroke="rgba(255,255,255,0.05)" stroke-width="8" fill="transparent"></circle>
                                    <circle cx="45" cy="45" r="${O}" stroke="var(--primary)" stroke-width="8" fill="transparent"
                                            stroke-dasharray="${q}"
                        ...
                        <div style="margin-top: 14px; text-align: center; font-size: 0.82rem; min-height: 24px; font-weight: 500;">
                            ${me?'<span style="color: var(--success); display: flex; align-items: center; justify-content: center; gap: 6px;"><i data-lucide="award" style="width: 16px; height: 16px;"></i> Wochenziel erreicht! 🎉 Super Arbeit!</span>':`<span style="color: var(--text-secondary);">Noch ${C-F} Bewerbung${C-F>1?"en":""} bis zum Ziel!</span>`}
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-split">
                    ...
                    <div class="glass-card split-card">
                        ...
                        <div class="event-list">
                            ${X.length>0?X.map(y=>`
                                <div class="event-item cursor-pointer" data-id="${y.id}" style="position: relative; padding-right: 50px;">
                                    <div class="event-badge">
                                        <span class="day">${y.day}</span>
                                        <span class="month">${y.month}</span>
                                    </div>
                                    <div class="event-details">
                                        <span class="event-title">${y.title}</span>
                                        <span class="event-company">${y.company}</span>
                                        <span class="event-time">
                                            <i data-lucide="calendar"></i> Frist: ${new Date(y.deadline).toLocaleDateString("de-DE")}
                                        </span>
                                    </div>
                                    <div style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); display: flex; gap: 6px; z-index: 5;">
                                        <button class="btn btn-secondary btn-export-ics" data-id="${y.id}" title="Als Kalenderdatei (.ics) exportieren" style="padding: 6px; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
                                            <i data-lucide="calendar-plus" style="width: 14px; height: 14px; color: var(--primary);"></i>
                                        </button>
                                        <button class="btn btn-secondary btn-google-cal" data-id="${y.id}" title="In Google Kalender eintragen" style="padding: 6px; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="glass-card split-card">
                        ...
                        <div class="reco-list">
                            ${Y.length>0?Y.map(y=>`
                                <div class="reco-item cursor-pointer" data-id="${y.id}">
                                    <div class="reco-details">
                                        <span class="reco-title">${y.title}</span>
                                        <span class="reco-company">${y.company}</span>
                                        <div class="reco-meta">
                                            <span class="reco-tag">${y.workMode}</span>
                                            ${y.salary?`<span class="reco-tag">${y.salary.toLocaleString("de-DE")} €</span>`:""}
                                        </div>
                                    </div>
                                    <div class="reco-score">
                                        <span class="score-badge">${y.compareScore}% Match</span>
        ...
        `,lucide.createIcons(),this.renderCharts(n,i),e.querySelectorAll(".event-item, .reco-item").forEach(y=>{y.addEventListener("click",()=>{const w=y.getAttribute("data-id");window.app.editJob(w)})}),e.querySelectorAll(".btn-export-ics").forEach(y=>{y.addEventListener("click",w=>{w.stopPropagation();const E=y.getAttribute("data-id"),I=n.find(T=>T.id===E);I&&R(()=>import("./ics-B67aMBsu.js"),[]).then(T=>{T.downloadCalendarEvent(I.title,I.company,I.deadline,I.description||""),window.app.showToast("Kalenderdatei (.ics) heruntergeladen!","success")}).catch(T=>{console.error("Failed to load ICS utility",T),window.app.showToast("Fehler beim Generieren des Kalendereintrags.","danger")})})}),e.querySelectorAll(".btn-google-cal").forEach(y=>{y.addEventListener("click",w=>{w.stopPropagation();const E=y.getAttribute("data-id"),I=n.find(T=>T.id===E);if(I){const T=`Bewerbungsfrist: ${I.title} bei ${I.company}`,B=`Link zur Anzeige: ${I.url||""}
Notizen: ${I.notes||""}`,oe=I.deadline.replace(/-/g,""),he=`${oe}/${oe}`,ye=`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(T)}&dates=${he}&details=${encodeURIComponent(B)}`;window.open(ye,"_blank"),window.app.showToast("Google Kalender geöffnet!","success")}})});const W=e.querySelector("#dash-tax-class"),U=e.querySelector("#dash-church-tax");if(W&&U){const y=()=>{const w=x.getProfile();w.taxClass=W.value,w.churchTax=U.value,x.saveProfile(w),this.renderSalaryChart(n,w),window.app.showToast("Steuereinstellungen aktualisiert!","success")};W.addEventListener("change",y),U.addEventListener("change",y)}const se=e.querySelector("#btn-goal-dec"),ae=e.querySelector("#btn-goal-inc");se&&ae&&(se.addEventListener("click",()=>{const y=x.getProfile();let w=y.weeklyGoal||3;w>1&&(w--,y.weeklyGoal=w,x.saveProfile(y),this.render(s),window.app.showToast("Wochenziel aktualisiert!","success"))}),ae.addEventListener("click",()=>{const y=x.getProfile();let w=y.weeklyGoal||3;w<20&&(w++,y.weeklyGoal=w,x.saveProfile(y),this.render(s),window.app.showToast("Wochenziel aktualisiert!","success"))}))},renderEmptyState(s){s.innerHTML=`
        ...
        `,lucide.createIcons(),this.initDragAndDrop(e),this.bindCardEvents(e),this.bindControlsEvents(e)},createCardHtml(s,e){const n=x.getProfile(),t=z.analyzeMatch(e||n.skills,s.description).matchScore;let r="low";t>=75?r="high":t>=40&&(r="medium");const a=s.deadline;let o=!1,l="Kein Datum";if(a){const g=new Date(s.deadline),f=new Date;f.setHours(0,0,0,0),o=g<f&&s.status!=="rejected"&&s.status!=="offer",l=g.toLocaleDateString("de-DE")}const c=new Date(s.createdAt||Date.now()),b=Math.abs(Date.now()-c.getTime()),p=Math.floor(b/(1e3*3600*24)),h=p===0?"heute":p===1?"gestern":`vor ${p} Tagen`;return`
            <div class="glass-card kanban-card" draggable="true" data-id="${s.id}" tabindex="0" role="button" aria-label="Bewerbung bei ${s.company} als ${s.title}. Match: ${t} Prozent.">
                ...
                <div class="card-meta-grid">
                    ...
                    ${s.salary?(()=>{const g=Q(s.salary,n);return`
                            <div class="meta-item" style="grid-column: span 2; display: flex; flex-direction: column; align-items: flex-start; gap: 2px;">
                                ...
                                <div style="font-size: 0.75rem; color: var(--text-secondary); margin-left: 20px;">
                                    ca. ${g.netMonthly.toLocaleString("de-DE")} € netto/Monat (StKl. ${n.taxClass||1})
                                </div>
                            </div>
                        `})():""}
                </div>
...
Gehalt: ${r.salary?r.salary+" €":"K.A."}`,c=`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(o)}&dates=${a}/${a}&details=${encodeURIComponent(l)}`;window.open(c,"_blank")}})})},bindControlsEvents(s){const e=s.querySelector("#kanban-filter-workmode"),n=s.querySelector("#kanban-sort-by");e&&e.addEventListener("change",i=>{this.filterWorkmode=i.target.value,this.render("view-kanban")}),n&&n.addEventListener("change",i=>{this.sortBy=i.target.value,this.render("view-kanban")})}},Ie={render(s){const e=document.getElementById(s),n=x.getJobs().filter(t=>t.status!=="rejected"),i=x.getWeights();e.innerHTML=`
        ...
        `,this.renderColumns(n,i),this.bindSliderEvents(e,n),lucide.createIcons()},renderColumns(s,e){const n=document.getElementById("matrix-cols-holder");if(!n)return;if(s.length===0){n.innerHTML=`
            ...
            `,lucide.createIcons();return}e?this.selectedJobId=e:(!this.selectedJobId||!i.some(o=>o.id===this.selectedJobId))&&(this.selectedJobId=i[0].id);const r=i.find(o=>o.id===this.selectedJobId)||i[0],a=z.analyzeMatch(t.skills,r.description);n.innerHTML=`
            <div class="kanban-header">
                    ...
                    <div class="glass-card" style="padding: 28px;">
                        ...
                        <div id="tab-cover-letter" class="tab-content active">
                            <div class="ai-card-header">
                                <h3 style="font-size: 1.1rem;"><i data-lucide="sparkles" style="color: var(--primary);"></i> Individuelles Bewerbungsanschreiben</h3>
                        ...
                        <div id="tab-interview-prep" class="tab-content">
                            <div class="ai-card-header">
                                <h3 style="font-size: 1.1rem;"><i data-lucide="help-circle" style="color: var(--secondary);"></i> Simulierte Gesprächsfragen &amp; Antworten</h3>
        ...
        `,lucide.createIcons(),this.bindEvents(n,r,t)},bindEvents(s,e,n){s.querySelectorAll(".job-selector-item").forEach(p=>{p.addEventListener("click",()=>{const h=p.getAttribute("data-id");this.selectedJobId=h,this.render("view-copilot")})}),s.querySelector("#copilot-edit-profile-btn").addEventListener("click",()=>{window.app.openProfileModal()}),s.querySelector("#copilot-edit-notes-btn").addEventListener("click",()=>{window.app.editJob(e.id)}),s.querySelectorAll(".tab-btn").forEach(p=>{p.addEventListener("click",()=>{s.querySelectorAll(".tab-btn").forEach(g=>g.classList.remove("active")),s.querySelectorAll(".tab-content").forEach(g=>g.classList.remove("active")),p.classList.add("active");const h=p.getAttribute("data-tab");s.querySelector(`#${h}`).classList.add("active")})});const i=s.querySelector("#btn-generate-letter"),t=s.querySelector("#ai-letter-output");i&&t&&i.addEventListener("click",async()=>{t.innerHTML=`
                    <div class="ai-loader">
                        <div class="ai-loader-spinner"></div>
                        <p>AI-Copilot analysiert die Anforderungen von ${e.company} und formuliert das Anschreiben...</p>
                    </div>
                `,i.disabled=!0;try{const p=await z.generateCoverLetter(n,e);t.innerHTML=`
                        ...
                        <div style="padding-top: 10px;">${p}</div>
                    `,lucide.createIcons(),document.getElementById("btn-tts-letter").addEventListener("click",()=>{if(!("speechSynthesis"in window)){window.app.showToast("Sprachausgabe wird nicht unterstützt.","warning");return}const h=document.getElementById("btn-tts-letter");if(window.speechSynthesis.speaking){window.speechSynthesis.cancel(),h.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons();return}const g=new SpeechSynthesisUtterance(p);g.lang="de-DE",h.innerHTML='<i data-lucide="volume-x" style="width: 14px; height: 14px;"></i> Stoppen',lucide.createIcons(),g.onend=()=>{h.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons()},g.onerror=()=>{h.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons()},window.speechSynthesis.speak(g)}),document.getElementById("btn-copy-letter").addEventListener("click",()=>{navigator.clipboard.writeText(p).then(()=>{window.app.showToast("In Zwischenablage kopiert!","success")}).catch(()=>{window.app.showToast("Fehler beim Kopieren.","danger")})}),document.getElementById("btn-pdf-letter").addEventListener("click",()=>{const h=document.getElementById("pdf-style-preset").value;R(()=>import("./pdfExport-B17vn1YC.js"),[]).then(g=>{g.printCoverLetter(n,e,p,h),window.app.showToast("Drucker-PDF-Dialog geöffnet!","success")}).catch(g=>{console.error("Failed to load PDF export utility",g),window.app.showToast("Fehler beim Generieren der PDF.","danger")})})}catch{t.innerHTML="Ein Fehler ist bei der Generierung aufgetreten. Bitte versuche es erneut."}finally{i.disabled=!1}});const r=s.querySelector("#btn-generate-prep"),a=s.querySelector("#ai-prep-output");r&&a&&r.addEventListener("click",async()=>{a.innerHTML=`
                    <div class="ai-loader">
                        <div class="ai-loader-spinner"></div>
                        <p>AI-Simulator bereitet 5 individuelle Gesprächsfragen vor...</p>
                    </div>
                `,r.disabled=!0;try{const p=await z.generateInterviewPrep(n,e);this.interviewQuestions=p,this.currentQuestionIdx=0,this.interviewScores=[],this.renderActiveQuestion(a,e,n)}catch(p){console.error(p),a.innerHTML="Ein Fehler ist bei der Vorbereitung aufgetreten. Bitte versuche es erneut."}finally{r.disabled=!1}});const o=s.querySelector("#btn-save-cv-text"),l=s.querySelector("#resume-cv-text"),c=s.querySelector("#btn-optimize-resume"),b=s.querySelector("#resume-optimize-results");o&&l&&o.addEventListener("click",()=>{const p=l.value,h=x.getProfile();h.cvText=p,x.saveProfile(h),window.app.showToast("Lebenslauf-Text erfolgreich gespeichert!","success")}),c&&b&&c.addEventListener("click",async()=>{const p=l.value.trim();if(!p){window.app.showToast("Bitte füge zuerst deinen Lebenslauf-Text ein.","warning");return}c.disabled=!0,c.innerHTML='<span class="ai-loader-spinner" style="width: 12px; height: 12px; border-width: 2px; display: inline-block; vertical-align: middle; margin-right: 5px;"></span> Optimiere...',b.innerHTML=`
                ...
                `;try{const h=await z.generateResumeOptimization(n,e,p);let g="low";h.score>=75?g="high":h.score>=40&&(g="medium");const f=h.matchingKeywords.length>0?h.matchingKeywords.map(d=>`<span class="keyword-badge match" style="font-size: 0.72rem;">${d}</span>`).join(""):'<span class="text-muted" style="font-size: 0.8rem;">Keine Keywords gefunden.</span>',u=h.missingKeywords.length>0?h.missingKeywords.map(d=>`<span class="keyword-badge miss" style="font-size: 0.72rem;">${d}</span>`).join(""):'<span class="text-muted" style="font-size: 0.8rem;">Perfektes Keyword-Match!</span>',m=h.bulletPoints.map(d=>`
                        <div class="bp-compare-card" style="background: rgba(255,255,255,0.015); border: 1px solid var(--border-color); border-radius: var(--radius-sm); padding: 12px 16px; display: flex; flex-direction: column; gap: 8px; margin-bottom: 10px;">
                            <div class="bp-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
                                <div style="opacity: 0.6; border-right: 1px solid var(--border-color); padding-right: 14px;">
                                    ...
                                    <p style="font-size: 0.82rem; margin: 0; color: var(--text-secondary); font-style: italic;">"${d.original}"</p>
                                </div>
                                <div>
                                    ...
                                    <p style="font-size: 0.82rem; margin: 0; color: var(--text-primary); font-weight: 500;">"${d.improved}"</p>
                                </div>
                            </div>
                    ...
                    `).join("");b.innerHTML=`
                        <div class="resume-results-scroll" style="display: flex; flex-direction: column; gap: 20px; overflow-y: auto; max-height: 520px; padding-right: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 18px; background: rgba(255,255,255,0.015); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 16px 20px;">
                                <div class="evaluation-score-badge ${g}" style="width: 54px; height: 54px; font-size: 1.3rem; font-weight: 800; display: flex; align-items: center; justify-content: center; border-radius: 50%;">${h.score}</div>
                                <div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
                                <div style="background: rgba(255,255,255,0.015); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 14px 16px;">
                                    ...
                                    <div class="keyword-tags" style="gap: 4px;">${f}</div>
                                </div>
                                <div style="background: rgba(255,255,255,0.015); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 14px 16px;">
                                    ...
                                    <div class="keyword-tags" style="gap: 4px;">${u}</div>
                                </div>
                            </div>
                            ...
                            <div style="background: rgba(99, 102, 241, 0.04); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 14px 18px;">
                                ...
                                <p style="font-size: 0.82rem; line-height: 1.5; color: var(--text-secondary); margin: 0;">${h.generalTips}</p>
                            </div>
                        </div>
                    `,lucide.createIcons()}catch(h){console.error(h),b.innerHTML=`
                        <div class="ai-output-box" style="border-color: var(--danger); background: rgba(244,63,94,0.05); color: var(--danger); text-align: center; padding: 24px;">
                            Fehler bei der Analyse: ${h.message}
                        </div>
                    `}finally{c.disabled=!1,c.innerHTML='<i data-lucide="sparkles"></i> Lebenslauf optimieren',lucide.createIcons()}})},bindAudioEvents(s,e){s.querySelectorAll(".btn-tts").forEach(g=>{g.addEventListener("click",()=>{const f=decodeURIComponent(g.getAttribute("data-text"));if(!("speechSynthesis"in window)){window.app.showToast("Sprachausgabe wird in diesem Browser leider nicht unterstützt.","warning");return}if(window.speechSynthesis.speaking){window.speechSynthesis.cancel(),g.classList.remove("active"),g.innerHTML='<i data-lucide="volume-2"></i> Vorlesen',lucide.createIcons();return}const u=new SpeechSynthesisUtterance(f);u.lang="de-DE",g.classList.add("active"),g.innerHTML='<i data-lucide="volume-x"></i> Stoppen',lucide.createIcons(),u.onend=()=>{g.classList.remove("active"),g.innerHTML='<i data-lucide="volume-2"></i> Vorlesen',lucide.createIcons()},u.onerror=()=>{g.classList.remove("active"),g.innerHTML='<i data-lucide="volume-2"></i> Vorlesen',lucide.createIcons()},window.speechSynthesis.speak(u)})});const n=window.SpeechRecognition||window.webkitSpeechRecognition;let i=null;n&&(i=new n,i.lang="de-DE",i.interimResults=!1,i.maxAlternatives=1);let t=null,r=null;s.querySelectorAll(".btn-stt").forEach(g=>{g.addEventListener("click",()=>{const f=g.getAttribute("data-id"),u=s.querySelector(`.user-answer-input[data-id="${f}"]`);if(!n){window.app.showToast("Spracherkennung (Diktieren) wird in diesem Browser nicht unterstützt. Bitte tippe deine Antwort ein.","warning");return}if(!(t!==null&&(i.stop(),t===f)))try{t=f,r=g,g.classList.add("recording"),g.innerHTML='<i data-lucide="mic-off"></i> Stoppen...',lucide.createIcons(),i.start(),i.onresult=m=>{const d=m.results[0][0].transcript;u.value.trim()?u.value+=" "+d:u.value=d},i.onerror=m=>{console.error(m),window.app.showToast("Fehler bei der Spracherkennung.","danger"),a()},i.onend=()=>{a()}}catch(m){console.error(m),a()}})});function a(){r&&(r.classList.remove("recording"),r.innerHTML='<i data-lucide="mic"></i> Antworten',lucide.createIcons()),t=null,r=null}s.querySelectorAll(".btn-evaluate").forEach(g=>{g.addEventListener("click",async()=>{const f=g.getAttribute("data-id"),u=s.querySelector(`.user-answer-input[data-id="${f}"]`),m=s.querySelector(`.evaluation-result-box[data-id="${f}"]`),d=s.querySelector(`.question-text[data-id="${f}"]`).textContent,v=u.value.trim();if(!v){window.app.showToast("Bitte trage oder spreche zuerst deine Antwort ein.","warning");return}g.disabled=!0,g.innerHTML='<span class="ai-loader-spinner" style="width: 12px; height: 12px; border-width: 2px; display: inline-block; vertical-align: middle; margin-right: 5px;"></span> Auswerten...',m.style.display="block",m.innerHTML=`
                ...
                `;try{const k=await z.evaluateInterviewAnswer(e.geminiApiKey,d,v);let S="low";k.score>=75?S="high":k.score>=50&&(S="medium"),m.innerHTML=`
                        <div class="evaluation-result-card">
                            <div style="display: flex; align-items: center; margin-bottom: 12px;">
                                <div class="evaluation-score-badge ${S}">${k.score}</div>
                                <div>
                                    <h4 style="font-size: 0.95rem; font-weight:600; margin: 0 0 2px 0; color: var(--text-primary);">AI-Coach Bewertung</h4>
                                    <span style="font-size: 0.75rem; color: var(--text-muted);">Ergebnis: ${k.score}/100 Punkte</span>
                                </div>
                            </div>
                            <div style="display: flex; flex-direction: column; gap: 8px; font-size: 0.85rem; line-height: 1.45;">
                                <div>
                                    ...
                                    <p style="color: var(--text-secondary); margin: 0;">${k.feedback}</p>
                                </div>
                                <div style="margin-top: 4px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 8px;">
                                    ...
                                    <p style="color: var(--text-secondary); margin: 0;">${k.suggestions}</p>
                                </div>
                            </div>
                        </div>
                    `}catch(k){console.error(k),m.innerHTML=`
                        <div class="evaluation-result-card" style="border-color: var(--danger); background: rgba(244,63,94,0.05);">
                            <span style="font-size: 0.85rem; color: var(--danger);">Fehler bei der Auswertung: ${k.message}</span>
                        </div>
                    `}finally{g.disabled=!1,g.innerHTML='<i data-lucide="sparkles"></i> Bewerten',lucide.createIcons()}})});const o=s.querySelector("#btn-generate-email"),l=s.querySelector("#ai-email-output"),c=s.querySelector("#email-type"),b=s.querySelector("#email-tone");o&&l&&o.addEventListener("click",async()=>{const g=c.value,f=b.value;l.innerHTML=`
                    <div class="ai-loader">
                        <div class="ai-loader-spinner"></div>
                        <p>AI-Assistent verfasst die E-Mail...</p>
                    </div>
                `,o.disabled=!0;try{const u=await z.generateEmail(e,activeJob,g,f);l.innerHTML=`
                        ...
                        <div style="padding-top: 10px; white-space: pre-wrap;">${u}</div>
                    `,lucide.createIcons(),document.getElementById("btn-tts-email").addEventListener("click",()=>{if(!("speechSynthesis"in window)){window.app.showToast("Sprachausgabe wird nicht unterstützt.","warning");return}const d=document.getElementById("btn-tts-email");if(window.speechSynthesis.speaking){window.speechSynthesis.cancel(),d.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons();return}const v=new SpeechSynthesisUtterance(u);v.lang="de-DE",d.innerHTML='<i data-lucide="volume-x" style="width: 14px; height: 14px;"></i> Stoppen',lucide.createIcons(),v.onend=()=>{d.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons()},v.onerror=()=>{d.innerHTML='<i data-lucide="volume-2" style="width: 14px; height: 14px;"></i> Vorlesen',lucide.createIcons()},window.speechSynthesis.speak(v)}),document.getElementById("btn-copy-email").addEventListener("click",()=>{navigator.clipboard.writeText(u).then(()=>{window.app.showToast("In Zwischenablage kopiert!","success")}).catch(()=>{window.app.showToast("Fehler beim Kopieren.","danger")})});const m=document.getElementById("btn-save-email-log");m&&m.addEventListener("click",()=>{activeJob.communicationLogs||(activeJob.communicationLogs=[]);const d=c.options[c.selectedIndex].text;activeJob.communicationLogs.push({id:Date.now().toString(),date:new Date().toISOString(),type:"E-Mail",subject:`Entwurf: ${d}`,content:u}),x.updateJob(activeJob),window.app.showToast("Entwurf im Kommunikationsverlauf gespeichert!","success"),m.disabled=!0,m.innerHTML='<i data-lucide="check" style="width: 14px; height: 14px;"></i> Gespeichert',lucide.createIcons()})}catch(u){console.error(u),l.innerHTML="Ein Fehler ist bei der Generierung aufgetreten. Bitte versuche es erneut."}finally{o.disabled=!1}});const p=s.querySelector("#btn-start-neg"),h=s.querySelector("#ai-neg-output");p&&h&&p.addEventListener("click",async()=>{const g=s.querySelector("#neg-target-salary"),f=s.querySelector("#neg-min-salary"),u=s.querySelector("#neg-persona"),m=parseFloat(g.value),d=parseFloat(f.value);if(isNaN(m)||m<=0){window.app.showToast("Bitte gib ein Wunschgehalt an.","warning");return}if(isNaN(d)||d<=0){window.app.showToast("Bitte gib deine Schmerzgrenze an.","warning");return}if(d>m){window.app.showToast("Die Schmerzgrenze darf nicht über dem Wunschgehalt liegen.","warning");return}this.negotiationTargetSalary=m,this.negotiationMinSalary=d,this.negotiationPersona=u.value,this.negotiationHistory=[],h.innerHTML=`
                    <div class="ai-loader">
                        <div class="ai-loader-spinner"></div>
                        <p>AI-Coach bereitet das Gehaltsgespräch vor...</p>
                    </div>
                `,p.disabled=!0;try{const v=e.geminiApiKey,k=await z.negotiateSalary(v,activeJob.title,activeJob.company,m,d,u.value,[],"Simulation starten");this.negotiationHistory.push({sender:"recruiter",text:k.text}),this.renderNegotiationChat(h,activeJob,e)}catch(v){console.error(v),h.innerHTML="Ein Fehler ist beim Starten aufgetreten. Bitte versuche es erneut.",p.disabled=!1}})},renderActiveQuestion(s,e,n){if(!this.interviewQuestions||this.interviewQuestions.length===0)return;const i=this.interviewQuestions[this.currentQuestionIdx],t=Math.round((this.currentQuestionIdx+1)/this.interviewQuestions.length*100);s.innerHTML=`
        ...
        `,lucide.createIcons();const r=s.querySelector(".btn-tts");r.addEventListener("click",()=>{if(!("speechSynthesis"in window)){window.app.showToast("Sprachausgabe wird nicht unterstützt.","warning");return}if(window.speechSynthesis.speaking){window.speechSynthesis.cancel(),r.innerHTML='<i data-lucide="volume-2"></i> Vorlesen',lucide.createIcons();return}const h=new SpeechSynthesisUtterance(i.question);h.lang="de-DE",r.innerHTML='<i data-lucide="volume-x"></i> Stoppen',lucide.createIcons(),h.onend=()=>{r.innerHTML='<i data-lucide="volume-2"></i> Vorlesen',lucide.createIcons()},window.speechSynthesis.speak(h)});const a=s.querySelector(".btn-stt"),o=window.SpeechRecognition||window.webkitSpeechRecognition;let l=null;o&&(l=new o,l.lang="de-DE",l.interimResults=!1),a.addEventListener("click",()=>{if(!o){window.app.showToast("Spracherkennung wird nicht unterstützt.","warning");return}if(a.classList.contains("recording")){l.stop();return}a.classList.add("recording"),a.innerHTML='<i data-lucide="mic-off"></i> Stoppen...',lucide.createIcons(),l.start(),l.onresult=h=>{const g=h.results[0][0].transcript;textarea.value=textarea.value.trim()?textarea.value+" "+g:g},l.onerror=()=>{window.app.showToast("Spracherkennung fehlgeschlagen.","danger"),c()},l.onend=()=>{c()}});const c=()=>{a.classList.remove("recording"),a.innerHTML='<i data-lucide="mic"></i> Antworten',lucide.createIcons()},b=s.querySelector(".btn-evaluate"),p=s.querySelector(".evaluation-result-box");b.addEventListener("click",async()=>{const h=textarea.value.trim();if(!h){window.app.showToast("Bitte trage eine Antwort ein.","warning");return}b.disabled=!0,b.innerHTML='<span class="ai-loader-spinner" style="width: 12px; height: 12px; border-width: 2px; display: inline-block; vertical-align: middle; margin-right: 5px;"></span> Bewerten...',p.style.display="block",p.innerHTML=`
            ...
            `;try{const g=n.geminiApiKey,f=await z.evaluateInterviewAnswer(g,i.question,h);this.interviewScores.push({id:i.id,question:i.question,answer:h,score:f.score,feedback:f.feedback,suggestions:f.suggestions});let u="low";f.score>=75?u="high":f.score>=50&&(u="medium"),p.innerHTML=`
                    <div class="evaluation-result-card" style="background: rgba(255, 255, 255, 0.015); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 16px; display: flex; flex-direction: column; gap: 12px;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <div class="evaluation-score-badge ${u}" style="width: 44px; height: 44px; font-size: 1.15rem; font-weight: 800; border-radius: 50%; display: flex; align-items: center; justify-content: center;">${f.score}</div>
                            <div>
                                <h4 style="font-size: 0.9rem; font-weight: 600; margin: 0; color: var(--text-primary);">Coach Bewertung</h4>
                                <span style="font-size: 0.75rem; color: var(--text-muted);">${f.score} / 100 Punkte</span>
                            </div>
                        </div>
                        <div style="font-size: 0.85rem; line-height: 1.45; color: var(--text-secondary);">
                            <p style="margin: 0 0 8px 0;"><strong>Feedback:</strong> ${f.feedback}</p>
                            <p style="margin: 0;"><strong>Vorschlag:</strong> ${f.suggestions}</p>
                        </div>
                    </div>
                `;const m=this.currentQuestionIdx===this.interviewQuestions.length-1;b.disabled=!1,b.innerHTML=m?'<i data-lucide="award"></i> Ergebnis anzeigen':'<i data-lucide="arrow-right"></i> Nächste Frage',b.style.background="linear-gradient(135deg, var(--success), var(--primary))",lucide.createIcons(),b.replaceWith(b.cloneNode(!0)),s.querySelector(".btn-evaluate").addEventListener("click",()=>{m?this.renderInterviewScorecard(s,e):(this.currentQuestionIdx++,this.renderActiveQuestion(s,e,n))})}catch(g){console.error(g),p.innerHTML=`
                    <div class="evaluation-result-card" style="border-color: var(--danger); background: rgba(244,63,94,0.05); color: var(--danger); font-size: 0.85rem; padding: 12px; border-radius: var(--radius-sm);">
                        Fehler bei der Bewertung: ${g.message}
                    </div>
        ...
        `,lucide.createIcons(),s.querySelector("#btn-restart-interview").addEventListener("click",()=>{const o=document.getElementById("btn-generate-prep");o&&(o.disabled=!1,o.click())});const a=s.querySelector("#btn-save-interview-log");a.addEventListener("click",()=>{e.communicationLogs||(e.communicationLogs=[]);const o=this.interviewScores.map((l,c)=>`Frage ${c+1}: ${l.question}
Antwort: ${l.answer}
Score: ${l.score}/100
Feedback: ${l.feedback}
`).join(`
...
`);e.communicationLogs.push({id:Date.now().toString(),date:new Date().toISOString(),type:"Vor-Ort-Gespräch",subject:`Interview-Training (Gesamt: ${i}/100)`,content:o}),x.updateJob(e),window.app.showToast("Trainingsergebnis im Kommunikationsverlauf gespeichert!","success"),a.disabled=!0,a.innerHTML='<i data-lucide="check" style="width: 14px; height: 14px;"></i> Gespeichert',lucide.createIcons()})},renderNegotiationChat(s,e,n){const i=Math.floor(this.negotiationHistory.length/2)+1,t=3;s.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 16px; text-align: left;">
                ...
                <div class="negotiation-chat-messages" style="display: flex; flex-direction: column; gap: 12px; max-height: 250px; overflow-y: auto; padding-right: 4px;">
                    ${this.negotiationHistory.map(l=>{const c=l.sender==="user";return`
                            <div style="display: flex; justify-content: ${c?"flex-end":"flex-start"}; width: 100%;">
                                <div style="max-width: 80%; background: ${c?"linear-gradient(135deg, var(--secondary), var(--primary))":"rgba(255,255,255,0.03)"}; border: 1px solid ${c?"transparent":"var(--border-color)"}; border-radius: var(--radius-md); padding: 12px 16px; color: var(--text-primary); font-size: 0.88rem; line-height: 1.45;">
                                    <span style="display: block; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; color: ${c?"rgba(255,255,255,0.7)":"var(--warning)"}; margin-bottom: 4px;">
                                        ${c?"Deine Antwort":"Recruiter"}
                                    </span>
                                    ${l.text}
                                </div>
                            </div>
...
Verlauf:
`+this.negotiationHistory.map(c=>`${c.sender==="user"?"Kandidat":"Recruiter"}: ${c.text}`).join(`
`);e.communicationLogs.push({id:Date.now().toString(),date:new Date().toISOString(),type:"Sonstiges",subject:`Gehaltsverhandlung (Ergebnis: ${t.toLocaleString("de-DE")} €)`,content:l}),e.salary=t,x.updateJob(e),window.app.showToast("Verhandlungsergebnis im Kommunikationsverlauf gespeichert!","success"),o.disabled=!0,o.innerHTML='<i data-lucide="check" style="width: 14px; height: 14px;"></i> Gespeichert',lucide.createIcons()}),s.querySelector("#btn-restart-neg").addEventListener("click",()=>{const l=document.getElementById("btn-start-neg");l&&(l.disabled=!1,l.click())})}};class ze{constructor(){this.currentView="dashboard",this.activeSkills=[],this.modalTodos=[],this.modalInterviews=[],this.modalExpenses=[],this.modalDocuments=[]}init(){this.initRouting(),this.initModals(),this.initGlobalSearch(),this.initNotificationBell(),this.initCvUpload(),this.renderCurrentView(),lucide.createIcons(),this.checkDeadlines(),this.applyAccessibilitySettings(),"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js").then(()=>console.log("Service Worker registered successfully.")).catch(e=>console.warn("Service Worker registration failed:",e))}applyAccessibilitySettings(){const e=x.getProfile();e.lrsEnabled?document.body.classList.add("lrs-mode"):document.body.classList.remove("lrs-mode"),e.rgsEnabled?document.body.classList.add("rgs-mode"):document.body.classList.remove("rgs-mode");const n=e.themePrimaryHue||239,i=e.themeSecondaryHue||263;document.documentElement.style.setProperty("--primary-hue",n),document.documentElement.style.setProperty("--secondary-hue",i)}initRouting(){const e=document.querySelectorAll(".sidebar-nav .nav-item");e.forEach(n=>{n.addEventListener("click",()=>{const i=n.getAttribute("data-view");e.forEach(t=>{t.classList.remove("active"),t.setAttribute("aria-selected","false")}),n.classList.add("active"),n.setAttribute("aria-selected","true"),this.switchToView(i)})})}switchToView(e,n=null){this.currentView=e,document.querySelectorAll(".app-view").forEach(a=>a.classList.remove("active"));const t=document.getElementById(`view-${e}`);t&&t.classList.add("active"),document.querySelectorAll(".sidebar-nav .nav-item").forEach(a=>{a.getAttribute("data-view")===e?(a.classList.add("active"),a.setAttribute("aria-selected","true")):(a.classList.remove("active"),a.setAttribute("aria-selected","false"))}),this.renderCurrentView(n)}renderCurrentView(e=null){const n=`view-${this.currentView}`;switch(this.currentView){case"dashboard":Se.render(n);break;case"kanban":Ee.render(n);break;case"comparer":Ie.render(n);break;case"copilot":Ae.render(n,e);break}}initGlobalSearch(){document.getElementById("global-search").addEventListener("input",n=>{const i=n.target.value.toLowerCase().trim();this.currentView!=="kanban"&&i.length>0&&this.switchToView("kanban"),document.querySelectorAll(".kanban-card").forEach(r=>{const a=r.querySelector(".card-title").textContent.toLowerCase(),o=r.querySelector(".card-company").textContent.toLowerCase();a.includes(i)||o.includes(i)?r.style.display="block":r.style.display="none"})})}initModals(){["salary","commute","remote","culture","tech","theme-primary","theme-secondary","gemini-temperature"].forEach(u=>{let m=`rate-${u}`,d=`val-${u}`;u.includes("theme")?(m=`profile-theme-${u.split("-")[1]}`,d=`val-theme-${u.split("-")[1]}`):u.includes("gemini")&&(m=`profile-gemini-${u.split("-")[1]}`,d=`val-gemini-${u.split("-")[1]}`);const v=document.getElementById(m),k=document.getElementById(d);v&&k&&v.addEventListener("input",S=>{k.textContent=S.target.value,u==="theme-primary"?document.documentElement.style.setProperty("--primary-hue",S.target.value):u==="theme-secondary"&&document.documentElement.style.setProperty("--secondary-hue",S.target.value)})});const n=document.getElementById("btn-test-api-key");n&&n.addEventListener("click",async()=>{const m=document.getElementById("profile-api-key").value.trim(),d=document.getElementById("api-key-test-feedback");if(!m){d.style.display="block",d.style.backgroundColor="rgba(239, 68, 68, 0.15)",d.style.color="#f87171",d.style.border="1px solid rgba(239, 68, 68, 0.3)",d.textContent="Bitte gib zuerst einen API-Key ein.";return}n.disabled=!0;const v=n.innerHTML;n.innerHTML='<span class="ai-loader-spinner" style="width: 14px; height: 14px; border-width: 2px; display: inline-block; vertical-align: middle; margin-right: 5px;"></span>...',d.style.display="block",d.style.backgroundColor="rgba(59, 130, 246, 0.15)",d.style.color="#60a5fa",d.style.border="1px solid rgba(59, 130, 246, 0.3)",d.textContent="Testverbindung wird aufgebaut...";try{await z.testApiKey(m)&&(d.style.backgroundColor="rgba(16, 185, 129, 0.15)",d.style.color="#34d399",d.style.border="1px solid rgba(16, 185, 129, 0.3)",d.textContent="Verbindung erfolgreich! Der API-Schlüssel ist gültig.",this.showToast("API-Key erfolgreich verifiziert!","success"))}catch(k){d.style.backgroundColor="rgba(239, 68, 68, 0.15)",d.style.color="#f87171",d.style.border="1px solid rgba(239, 68, 68, 0.3)",d.textContent="Verbindung fehlgeschlagen: "+k.message,this.showToast("API-Key Verifizierung fehlgeschlagen.","danger")}finally{n.disabled=!1,n.innerHTML=v}}),document.getElementById("btn-add-job-top").addEventListener("click",()=>this.openJobModal()),document.getElementById("btn-open-profile").addEventListener("click",()=>this.openProfileModal());const i=document.getElementById("profile-select");i&&i.addEventListener("change",u=>{x.setActiveProfileId(u.target.value);const m=x.getProfile();this.loadProfileFields(m),this.applyAccessibilitySettings(),this.showToast(`Zu Profil "${m.profileName}" gewechselt`,"primary")});const t=document.getElementById("btn-create-profile");t&&t.addEventListener("click",()=>{const u=document.getElementById("new-profile-name-input"),m=u.value.trim();if(!m){this.showToast("Bitte gib einen Profilnamen ein.","warning");return}const d=x.addProfile(m);u.value="",this.populateProfilesSelect(),this.loadProfileFields(d),this.applyAccessibilitySettings(),this.showToast(`Profil "${m}" erfolgreich erstellt!`,"success")});const r=document.getElementById("btn-delete-current-profile");r&&r.addEventListener("click",()=>{const u=x.getActiveProfileId(),m=x.getProfile();try{x.deleteProfile(u);const d=x.getProfile();this.populateProfilesSelect(),this.loadProfileFields(d),this.applyAccessibilitySettings(),this.showToast(`Profil "${m.profileName}" gelöscht.`,"warning")}catch(d){this.showToast(d.message,"danger")}}),document.getElementById("btn-close-job-modal").addEventListener("click",()=>this.closeModal("job-modal")),document.getElementById("btn-cancel-job-modal").addEventListener("click",()=>this.closeModal("job-modal")),document.getElementById("btn-close-profile-modal").addEventListener("click",()=>this.closeModal("profile-modal")),document.querySelectorAll(".modal-backdrop").forEach(u=>{u.addEventListener("click",m=>{m.target===u&&this.closeModal(u.id)})});const a=document.getElementById("btn-parse-job");a&&a.addEventListener("click",async()=>{let u=document.getElementById("job-raw-text").value;const m=document.getElementById("job-raw-url").value.trim();if((!u||!u.trim())&&!m){this.showToast("Bitte füge eine Stellenbeschreibung oder eine URL ein.","warning");return}a.disabled=!0,a.innerHTML='<span class="ai-loader-spinner" style="width: 14px; height: 14px; border-width: 2px; display: inline-block; vertical-align: middle; margin-right: 5px;"></span> Parsen...';try{m&&(!u||!u.trim())&&(this.showToast("Lade Stellenbeschreibung von URL...","primary"),u=await z.fetchJobDescriptionFromUrl(m),document.getElementById("job-description").value=u);const d=x.getProfile(),v=await z.parseJobDescription(d.geminiApiKey,u);v.title&&(document.getElementById("job-title").value=v.title),v.company&&(document.getElementById("job-company").value=v.company),v.salary&&(document.getElementById("job-salary").value=v.salary),v.location&&(document.getElementById("job-location").value=v.location),v.workMode&&(document.getElementById("job-work-mode").value=v.workMode),v.description&&(document.getElementById("job-description").value=v.description),v.contact&&(document.getElementById("job-contact").value=v.contact),m&&(document.getElementById("job-url").value=m),this.showToast("Stellenbeschreibung erfolgreich analysiert!","success"),document.getElementById("job-raw-text").value="",document.getElementById("job-raw-url").value=""}catch(d){console.error(d),this.showToast("Fehler beim Analysieren der Anzeige: "+d.message,"danger")}finally{a.disabled=!1,a.innerHTML='<i data-lucide="wand-2"></i> Parsen',lucide.createIcons()}}),document.getElementById("job-form").addEventListener("submit",u=>this.handleJobSubmit(u)),document.getElementById("btn-save-profile").addEventListener("click",()=>this.handleProfileSubmit()),document.getElementById("btn-export-cv").addEventListener("click",()=>{const u=x.getProfile();R(()=>import("./cvExport-DXFbwjG_.js"),[]).then(m=>{m.printCurriculumVitae(u),this.showToast("Lebenslauf-Druckdialog geöffnet!","success")}).catch(m=>{console.error(m),this.showToast("Fehler beim Lebenslauf-Export.","danger")})}),document.getElementById("btn-add-skill").addEventListener("click",u=>{u.preventDefault(),this.handleSkillAdd()}),document.getElementById("new-skill-input").addEventListener("keypress",u=>{u.key==="Enter"&&(u.preventDefault(),this.handleSkillAdd())}),document.getElementById("btn-export-data").addEventListener("click",()=>this.handleDataExport()),document.getElementById("btn-trigger-import").addEventListener("click",()=>{document.getElementById("import-file-input").click()}),document.getElementById("import-file-input").addEventListener("change",u=>this.handleDataImport(u));const o=document.querySelectorAll(".modal-tab-btn"),l=document.querySelectorAll(".modal-tab-content");o.forEach(u=>{u.addEventListener("click",()=>{o.forEach(v=>{v.classList.remove("active"),v.style.color="var(--text-secondary)"}),l.forEach(v=>{v.style.display="none"}),u.classList.add("active"),u.style.color="var(--text-primary)";const m=u.getAttribute("data-modal-tab"),d=document.getElementById(m);d&&(d.style.display="block")})});const c=document.getElementById("btn-modal-add-todo");c&&(c.addEventListener("click",()=>{const u=document.getElementById("modal-todo-input"),m=u.value.trim();if(!m){this.showToast("Bitte gib einen Aufgabentext ein.","warning");return}this.modalTodos.push({id:Date.now().toString(),text:m,completed:!1}),u.value="",this.renderModalTodos()}),document.getElementById("modal-todo-input").addEventListener("keypress",u=>{u.key==="Enter"&&(u.preventDefault(),c.click())}));const b=document.getElementById("btn-modal-add-interview");b&&b.addEventListener("click",()=>{const u=document.getElementById("modal-interview-date"),m=document.getElementById("modal-interview-round"),d=document.getElementById("modal-interview-interviewer"),v=document.getElementById("modal-interview-notes"),k=m.value.trim();if(!k){this.showToast("Bitte gib die Gesprächsrunde an.","warning");return}this.modalInterviews.push({id:Date.now().toString(),date:u.value,round:k,interviewer:d.value.trim(),notes:v.value.trim()}),u.value="",m.value="",d.value="",v.value="",this.renderModalInterviews()});const p=document.getElementById("btn-modal-add-history");p&&p.addEventListener("click",()=>{const u=document.getElementById("modal-history-date"),m=document.getElementById("modal-history-type"),d=document.getElementById("modal-history-subject"),v=document.getElementById("modal-history-content"),k=d.value.trim(),S=u.value;if(!S){this.showToast("Bitte gib ein Datum an.","warning");return}if(!k){this.showToast("Bitte gib einen Betreff an.","warning");return}this.modalHistory.push({id:Date.now().toString(),date:S,type:m.value,subject:k,content:v.value.trim()}),u.value="",d.value="",v.value="",this.renderModalHistory()});const h=document.getElementById("btn-modal-add-expense");h&&h.addEventListener("click",()=>{const u=document.getElementById("modal-expense-date"),m=document.getElementById("modal-expense-category"),d=document.getElementById("modal-expense-amount"),v=document.getElementById("modal-expense-notes"),k=u.value,S=parseFloat(d.value);if(!k){this.showToast("Bitte gib ein Datum an.","warning");return}if(isNaN(S)||S<=0){this.showToast("Bitte gib einen gültigen Betrag an.","warning");return}this.modalExpenses.push({id:Date.now().toString(),date:k,category:m.value,amount:S,notes:v.value.trim()}),u.value="",d.value="",v.value="",this.renderModalExpenses()});const g=document.getElementById("btn-trigger-doc-upload"),f=document.getElementById("job-doc-upload");g&&f&&(g.addEventListener("click",()=>{f.click()}),f.addEventListener("change",async u=>{const m=u.target.files[0];if(!m)return;if(m.size>10*1024*1024){this.showToast("Die Datei darf maximal 10 MB groß sein.","warning");return}const d=Date.now().toString(),v=document.getElementById("job-id").value||"temp_"+d;try{await Z.saveFile(d,v,m.name,m),this.modalDocuments.push({id:d,name:m.name,size:m.size,type:m.type,uploadDate:new Date().toISOString()}),this.showToast("Dokument erfolgreich hochgeladen!","success"),this.renderModalDocuments()}catch(k){console.error("IndexedDB upload failed",k),this.showToast("Fehler beim Upload des Dokuments.","danger")}finally{f.value=""}}))}openJobModal(e=null){const n=document.getElementById("job-modal"),i=document.getElementById("job-form"),t=document.getElementById("modal-title");i.reset(),document.getElementById("job-id").value="";const r=["salary","commute","remote","culture","tech"];r.forEach(b=>{document.getElementById(`val-${b}`).textContent="5"});const a=document.querySelectorAll(".modal-tab-btn"),o=document.querySelectorAll(".modal-tab-content");a.forEach(b=>{b.classList.remove("active"),b.style.color="var(--text-secondary)"}),o.forEach(b=>{b.style.display="none"});const l=document.querySelector('[data-modal-tab="modal-tab-details"]');l&&(l.classList.add("active"),l.style.color="var(--text-primary)");const c=document.getElementById("modal-tab-details");if(c&&(c.style.display="block"),e){t.textContent="Jobangebot bearbeiten";const p=x.getJobs().find(h=>h.id===e);if(p){document.getElementById("job-id").value=p.id,document.getElementById("job-title").value=p.title,document.getElementById("job-company").value=p.company,document.getElementById("job-location").value=p.location||"",document.getElementById("job-work-mode").value=p.workMode||"Hybrid",document.getElementById("job-salary").value=p.salary||"",document.getElementById("job-url").value=p.url||"",document.getElementById("job-deadline").value=p.deadline||"",document.getElementById("job-description").value=p.description||"",document.getElementById("job-contact").value=p.contact||"",document.getElementById("job-notes").value=p.notes||"",document.getElementById("job-status").value=p.status||"saved",this.modalTodos=Array.isArray(p.todos)?[...p.todos]:[],this.modalInterviews=Array.isArray(p.interviews)?[...p.interviews]:[],this.modalHistory=Array.isArray(p.communicationLogs)?[...p.communicationLogs]:[],this.modalExpenses=Array.isArray(p.expenses)?[...p.expenses]:[],this.modalDocuments=Array.isArray(p.documents)?[...p.documents]:[];const h=p.ratings||{salary:5,commute:5,remote:5,culture:5,tech:5};r.forEach(u=>{const m=document.getElementById(`rate-${u}`),d=document.getElementById(`val-${u}`);m&&d&&(m.value=h[u],d.textContent=h[u])});const g=document.getElementById("job-history-timeline"),f=document.getElementById("job-timeline-nodes");if(p.history&&p.history.length>0){const u={saved:"Gespeichert (Interessant)",prepared:"Unterlagen bereit",applied:"Beworben",interviewing:"Gespräch / Interview",offer:"Angebot erhalten",rejected:"Absage"};f.innerHTML=p.history.map(m=>{const d=new Date(m.timestamp).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"});return`
                            <div class="timeline-node">
                                <span class="status-name">${u[m.status]||m.status}</span>
                                <span class="status-date">${d}</span>
                            </div>
                        `}).join(""),g.style.display="block"}else g.style.display="none"}}else t.textContent="Neues Jobangebot eintragen",document.getElementById("job-status").value="saved",document.getElementById("job-history-timeline").style.display="none",this.modalTodos=[],this.modalInterviews=[],this.modalHistory=[],this.modalExpenses=[],this.modalDocuments=[];this.renderModalTodos(),this.renderModalInterviews(),this.renderModalHistory(),this.renderModalExpenses(),this.renderModalDocuments(),n.classList.add("active")}editJob(e){this.openJobModal(e)}closeModal(e){document.getElementById(e).classList.remove("active")}handleJobSubmit(e){e.preventDefault();const n=document.getElementById("job-id").value,i={title:document.getElementById("job-title").value,company:document.getElementById("job-company").value,location:document.getElementById("job-location").value,workMode:document.getElementById("job-work-mode").value,salary:document.getElementById("job-salary").value?parseInt(document.getElementById("job-salary").value):null,url:document.getElementById("job-url").value,deadline:document.getElementById("job-deadline").value,description:document.getElementById("job-description").value,contact:document.getElementById("job-contact").value,notes:document.getElementById("job-notes").value,status:document.getElementById("job-status").value,todos:this.modalTodos,interviews:this.modalInterviews,communicationLogs:this.modalHistory,expenses:this.modalExpenses||[],documents:this.modalDocuments||[],ratings:{salary:parseInt(document.getElementById("rate-salary").value),commute:parseInt(document.getElementById("rate-commute").value),remote:parseInt(document.getElementById("rate-remote").value),culture:parseInt(document.getElementById("rate-culture").value),tech:parseInt(document.getElementById("rate-tech").value)}};if(n){const r=x.getJobs().find(l=>l.id===n);let a=r.history||[];Array.isArray(a)||(a=[]),r.status!==i.status&&a.push({status:i.status,timestamp:new Date().toISOString()});const o={...r,...i,history:a};x.updateJob(o),this.showToast("Job erfolgreich aktualisiert","success")}else{const t={...i,history:[{status:i.status,timestamp:new Date().toISOString()}]};x.addJob(t),this.showToast("Neuer Job hinzugefügt!","success")}this.closeModal("job-modal"),this.renderCurrentView()}populateProfilesSelect(){const e=document.getElementById("profile-select");if(!e)return;const n=x.getProfiles(),i=x.getActiveProfileId();e.innerHTML=n.map(t=>`
            <option value="${t.id}" ${t.id===i?"selected":""}>${t.profileName}</option>
        `).join("")}loadProfileFields(e){document.getElementById("profile-name").value=e.name||"",document.getElementById("profile-title").value=e.title||"",document.getElementById("profile-experience").value=e.experience||"",document.getElementById("profile-notifications").checked=!!e.notificationsEnabled,document.getElementById("profile-api-key").value=e.geminiApiKey||"",document.getElementById("profile-lrs").checked=!!e.lrsEnabled,document.getElementById("profile-rgs").checked=!!e.rgsEnabled,document.getElementById("profile-tax-class").value=e.taxClass||"1",document.getElementById("profile-church-tax").value=e.churchTax||"0",document.getElementById("profile-has-children").checked=!!e.hasChildren,document.getElementById("profile-supabase-url").value=e.supabaseUrl||"",document.getElementById("profile-supabase-key").value=e.supabaseAnonKey||"",document.getElementById("profile-theme-primary").value=e.themePrimaryHue||239,document.getElementById("val-theme-primary").textContent=e.themePrimaryHue||239,document.getElementById("profile-theme-secondary").value=e.themeSecondaryHue||263,document.getElementById("val-theme-secondary").textContent=e.themeSecondaryHue||263,document.getElementById("profile-gemini-model").value=e.geminiModel||"gemini-1.5-flash",document.getElementById("profile-gemini-temperature").value=e.geminiTemperature!==void 0?e.geminiTemperature:.7,document.getElementById("val-gemini-temperature").textContent=e.geminiTemperature!==void 0?e.geminiTemperature:.7,document.getElementById("profile-gemini-instructions").value=e.geminiCustomInstructions||"",this.activeSkills=[...e.skills||[]],this.renderSkillTags()}openProfileModal(){const e=document.getElementById("profile-modal"),n=x.getProfile();this.populateProfilesSelect(),this.loadProfileFields(n);const i=document.getElementById("api-key-test-feedback");i&&(i.style.display="none",i.textContent=""),e.classList.add("active")}handleSkillAdd(){const e=document.getElementById("new-skill-input"),n=e.value.trim();n&&(n.split(",").map(t=>t.trim()).filter(t=>t.length>0).forEach(t=>{this.activeSkills.some(r=>r.toLowerCase()===t.toLowerCase())||this.activeSkills.push(t)}),e.value="",this.renderSkillTags())}removeSkill(e){this.activeSkills=this.activeSkills.filter(n=>n!==e),this.renderSkillTags()}renderSkillTags(){const e=document.getElementById("profile-skills-list");e.innerHTML=this.activeSkills.map(n=>`
            <div class="skill-tag">
                <span>${n}</span>
